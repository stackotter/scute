...
struct CoreServicesFileSystemWatcher {
    ...
    static func startWatching(paths: [String], with handler: @escaping (FileSystemWatcher.Event) -> (), errorHandler: @escaping (Swift.Error) -> Void) throws {
    ...
    static func startWatchingForDebouncedModifications(paths: [String], with handler: @escaping () -> Void, errorHandler: @escaping (Swift.Error) -> Void) throws {
...
extension FileSystemWatcher {
    ...
    final class EventStream {
        ...
        func getLatestEventID() -> FileSystemWatcher.EventID {
        ...
        func flushAsync() -> FileSystemWatcher.EventID {
